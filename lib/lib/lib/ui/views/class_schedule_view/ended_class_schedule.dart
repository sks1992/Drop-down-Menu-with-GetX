...
class EndedClassSchedule extends StatelessWidget {
  final String classType = "E";
      ...
      child: GetBuilder<ClassScheduleController>(
        ...
        builder: (_controller) {
          return _controller.obx(
            (_classSchedule) => _classSchedule == null ||
                    !_classSchedule.isSuccess
                ? Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              IconWithText(
                  ...
                  text: "  ${getFormattedDateTime(a.scheduleDate)}"),
              SizedBox(
                height: 5,
              ),
